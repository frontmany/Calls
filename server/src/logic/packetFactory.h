...
namespace server
{
    ...
    public:
        ...
        static std::vector<unsigned char> getReconnectionResultPacket(bool reconnectedSuccessfully, const std::string& uid, const std::string& receiverNicknameHash, const std::string& receiverToken, std::optional<bool> activeCall = std::nullopt, const std::string& callPartnerNicknameHash = "", std::optional<bool> isInMeeting = std::nullopt);
