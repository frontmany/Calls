...
namespace calls {
    ...
    public:
        ...
        static std::pair<std::string, std::string> getDeclineAllCallsPacket(const std::string& myNickname, const std::vector<std::string>& nicknames, bool forLogout);
        static std::pair<std::string, std::string> getAcceptCallPacket(const std::string& myNickname, const std::string& friendNickname);
