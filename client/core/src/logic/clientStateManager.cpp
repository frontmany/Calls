...
void ClientStateManager::reset()
{
    ...
    m_mediaStates[media::MediaType::Screen] = media::MediaState::Stopped;
    m_mediaStates[media::MediaType::Camera] = media::MediaState::Stopped;
    m_mediaStates[media::MediaType::Audio] = media::MediaState::Stopped;
}