...
namespace core
{
    namespace services
    {
        ...
        {
            if (!data || size <= 0) {
                LOG_WARN("MediaEncryptionService::encryptMedia: invalid input");
                return {};
            }
            ...
            try {
                ...
                LOG_ERROR("MediaEncryptionService::encryptMedia failed: {}", e.what());
                return {};
            }
        }
        ...
        {
            if (!data || size <= 0) {
                LOG_WARN("MediaEncryptionService::decryptMedia: invalid input");
                return {};
            }

            if (size <= CryptoPP::AES::BLOCKSIZE) {
                LOG_WARN("MediaEncryptionService::decryptMedia: data too small to decrypt: {} bytes", size);
                return {};
            }
            ...
            try {
                ...
                LOG_ERROR("MediaEncryptionService::decryptMedia failed: {}", e.what());
                return {};
            }
        }
    }
